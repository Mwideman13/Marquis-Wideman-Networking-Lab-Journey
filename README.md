...
|---|-----|---------------|--------|
| 01 | [Basic Topology & Cabling](./labs/01-basic-topology/) | Physical topology, device connections, console access | ✅ Completed |
| 02 | [VLANs & Trunking](./labs/02-vlans/) | VLAN creation, trunk ports, inter-VLAN routing | 🔄 Started |
